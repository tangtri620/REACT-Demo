                ...
                <div className="carousel-inner">
                  ...
                  <div className="carousel-item" data-bs-interval="3000">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                      ...
                      <p>
                        Some representative placeholder content for the fifth
                        slide.
                      </p>
                    </div>
                  </div>
            ...
            <div className="col-md-3">
              <div className="card position-relative">
                ...
                <div className="card-body">
                  ...
                  <p className="pizza-price"><s>$24.00</s> $14.99</p>
                ...
                <div className="col-md-3">
                  <div className="card">
                    ...
                    />
                    <div className="card-body">
                      <h5 className="card-title">Marggerita Pizza</h5>
                      <p className="text-mute">$25</p>
                      <a href="#" className="form-control btn btn-dark">
                        Buy
                      </a>
                    </div>
